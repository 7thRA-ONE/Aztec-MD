...
module.exports = async (vorterx, m, commands, pushName, botName, chatUpdate) => {
  try {
    ...
    if (body.startsWith(prefix) && !icmd) {
      var aztec = `https://i.ibb.co/wKzdRH6/vorterx.png`;
      let txtt = `*Hey ${pushName} how are you\n\n🚦BotName: ${process.env.BOTNAME}\n\n🌵Version: 3.0.0\n\nUnfortunately ${prefix}${cmdName}* cannot found*`;
      vorterx.sendMessage(m.from, {image:{url:aztec}, caption:txtt}, { quoted: m });
    }
